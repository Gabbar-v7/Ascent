...
class RoutinesIndexState extends State<RoutinesIndex> {
        ...
        child: ListTile(
          ...
          subtitle: Row(
            children: [
              ...
              const Gap(4),
              Text(routine.body ?? "not defined", style: textTheme.bodySmall),
            ],
          ),
          trailing: Text("x${routine.streak}", style: textTheme.titleLarge),
        ),
      ),
    );
  }
  ...
  Future<void> _fetchRoutines() async {
    await (database.select(database.routines).get());
